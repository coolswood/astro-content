...
export const GET: APIRoute = async ({ params }) => {
  ...
  try {
    ...
    const content = module.default.gptCbt;
    ...
    console.error(
      `Error generating src/pages/api/mindhealth/[lang]/texts/daybook/gptCbt.html.ts:`,
      err,
    );
    throw new Error(
      `Failed to generate src/pages/api/mindhealth/[lang]/texts/daybook/gptCbt.html.ts: ${err instanceof Error ? err.message : String(err)}`,
    );
  }
};
