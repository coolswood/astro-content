...
// Миграция файла history по аналогии с Вашим start.json.ts (минимально; без лишней логики).
...
export const GET: APIRoute = async ({ params }) => {
  ...
  try {
    ...
    // Получаем common для stepper (хотя в history они не используются)
    ...
    console.error(
      `Error generating src/pages/api/mindhealth/[lang]/story/base/history.json.ts:`,
      err,
    );
    throw new Error(
      `Failed to generate src/pages/api/mindhealth/[lang]/story/base/history.json.ts: ${
