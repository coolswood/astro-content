...
// Миграция файла diary по аналогии с Вашим start.json.ts (минимально; без лишней логики).
...
export const GET: APIRoute = async ({ params }) => {
  ...
  try {
    ...
    // Получаем common для stepper (хотя в diary они не используются)
    ...
    throw new Error(
      `Failed to generate src/pages/api/mindhealth/[lang]/story/base/diary.json.ts: ${
