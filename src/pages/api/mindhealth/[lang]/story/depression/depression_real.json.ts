...
export const GET: APIRoute = async ({ params }) => {
  ...
  try {
    ...
    story = fullStory.real;

    const taggedScreens = hasTaggedStory(story)
      ? buildTaggedStoryScreens(story, {}, { correctAnswer: 2 })
      : undefined;
    ...
    console.error(
      `Error generating src/pages/api/mindhealth/[lang]/story/depression/depression_real.json.ts:`,
      err,
    );
    throw new Error(
      `Failed to generate src/pages/api/mindhealth/[lang]/story/depression/depression_real.json.ts: ${
