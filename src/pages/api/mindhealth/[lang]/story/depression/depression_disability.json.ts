...
export const GET: APIRoute = async ({ params }) => {
  ...
  try {
    ...
    const taggedScreens = hasTaggedStory(story)
      ? buildTaggedStoryScreens(story, { instagramFallback: storyEn.instagram }, { correctAnswer: 1 })
      : undefined;
    ...
    console.error(
      `Error generating src/pages/api/mindhealth/[lang]/story/depression/depression_disability.json.ts:`,
      err,
    );
    throw new Error(
      `Failed to generate src/pages/api/mindhealth/[lang]/story/depression/depression_disability.json.ts: ${
