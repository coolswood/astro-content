...
echo "🔍 Сравнение структуры JSON файлов в папке uk с веткой main..."

# Получаем список JSON файлов в uk директории
find src/i18n/uk -name "*.json" -type f | while read file; do
